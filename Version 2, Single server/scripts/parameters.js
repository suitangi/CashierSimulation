window.expParam = {
  ...
  customerArrivalRates: [1 / 60, 2 / 60, 3 / 60, 4 / 60, 5 / 60], //per second
  ...
  //},
  {
    question: 'This is an individual task, composed of multiple sessions, where you will be acting as a cashier in a supermarket. Your customers each have 3 items in their cart (see the illustration below). To process a customer’s order, slide each bar to match the listed price. Once all items are matched correctly, click submit button to move to the next cart. The “Submit Cart” button will remain inactive until you correctly set all three prices. <br><img src="./img/screen1.png"> <br><br> Further instructions will be provided as you move along the experiment.',
    type: 'text',
    title: 'Environment'
  }, ],
